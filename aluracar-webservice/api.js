...
module.exports = app => {
    ...
    function enviaNotificacao(agendamento) {
        ...
        const message = { 
            app_id: "ONESIGNAL APP ID", //ONESIGNAL APP ID (Procurar no serviço cadastrado no onesignal)
        ...
        const headers = {
            ...
            "Authorization": "Basic REST API KEY" //REST API KEY (Procurar no serviço cadastrado no onesignal)
        };
